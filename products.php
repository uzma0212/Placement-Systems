...
<html>
	<head>
		...
		<title>TMSL | Campus Drives</title>
		<meta name="viewport"
					...
					<div class="top-nav">
						...
						<ul class="nav1">
							...
							<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">TMSL<i>Goto Placement Homepage</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
			...
			<div class="container">
				...
				<div class="products-top-grids wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<div class="col-md-4 products-grid">
						...
						<div class="products-text">
							...
							<div class="see-button">
								<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href="https://en.wikipedia.org/wiki/Tata_Consultancy_Services" target="_blank" role="button" >See More</a>
							</div>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-4 products-grid">
						...
						<div class="products-text">
							<h4>Infosys</h4>
							<div class="see-button">
								<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href="https://en.wikipedia.org/wiki/Infosys" target="_blank" role="button">See More</a>
							</div>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-4 products-grid">
						...
						<div class="products-text">
							<h4>Deloitte</h4>
							<p></p>
							<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href="https://en.wikipedia.org/wiki/Deloitte" target="_blank" role="button">See More</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				...
				<div class="products-top-grids wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<div class="col-md-4 products-grid">
						...
						<div class="products-text">
							<h4>Microsoft</h4>
							<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href="https://en.wikipedia.org/wiki/Microsoft" target="_blank" role="button">See More</a>
							<p></p>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-4 products-grid">
						...
						<div class="products-text">
							<h4>LTI </h4>
							<p></p>
							<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href="https://en.wikipedia.org/wiki/Larsen_%26_Toubro_Infotech" target="_blank" role="button">See More</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-4 products-grid">
						...
						<div class="products-text">
							<h4>Cerner</h4>
							<p></p>
							<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal" href="https://en.wikipedia.org/wiki/Cerner"  target="_blank" role="button">See More</a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
			...
			<div class="container">
				...
				<div class="products-bottom-grids">
					<div class="gallery-grids">
						...
						<div class="gallery-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
							<a class="fancybox" href="images/bill.jpg" data-fancybox-group="gallery"><img src="images/lti.png" class="img-style row6" alt=""><span> </span></a>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="gallery-grids">
						...
						<div class="gallery-grid1 wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
							<a class="fancybox" href="images/goo.png" data-fancybox-group="gallery"><img src="images/deloitte.jpg" class="img-style row6" alt=""><span> </span></a>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
