...
<center><label class="control-label" for="inputNote"><br/> <br/>To Upload an Image or a file Click the Link below:</label><br/>
			   <br/>
			   <a href="upload.html" class="templatemo-blue-button">Post</a></center>
            </form>
          </div>
