...
CREATE TABLE IF NOT EXISTS `basicdetails` (
  ...
  PRIMARY KEY (`ROLL`),
  UNIQUE KEY `ROLL` (`ROLL`,`Mobile`,`Email`)
...
INSERT INTO `basicdetails` (`FirstName`, `LastName`, `ROLL`, `Mobile`, `Email`, `DOB`, `Sem`, `Branch`, `SSLC`, `PU/Dip`, `BE`, `Backlogs`, `HofBacklogs`, `DetainYears`, `Approve`, `ApprovalDate`) VALUES
('veda', 'kumar', '1234', 11111, 'v@gmil.comk', '2015-06-09', 1, 'ISE', 70, 70, 70, 0, 0, 0, 1, '0000-00-00'),
...
ALTER TABLE `updatedrive`
  ADD CONSTRAINT `updatedrive_ibfk_1` FOREIGN KEY (`ROLL`) REFERENCES `basicdetails` (`ROLL`) ON DELETE CASCADE,
...
INSERT INTO `slogin` (`id`, `Name`, `ROLL`, `PASSWORD`, `Email`, `Question`, `Answer`) VALUES
(1, 'veda', '12', '123', 'veda', 'What is your fav spot?', 'cricket'),
