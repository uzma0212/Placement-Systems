...
<body>
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>Techno India is a group of engineering and management colleges, high schools and primary schools. Techno model school and Techno India group public schools are located in different towns and cities in West Bengal. Each district of West Bengal has one public school by Techno. It also offers undergraduate and post graduate programs in the field of Science, engineering, technology, computer application, management, architecture, pharmacy, humanities, law, commerce, etc. The main campus of the college is situated in Saltlake. The college is an AICTE-approved institution and is affiliated to Maulana Abul Kalam Azad University of Technology.[1] Techno India is the flagship college and the main placement center for the Techno India group of colleges in West Bengal. 
						</p>
					</div>
				</div>
				<div class="clearfix"> </div>
	...
	<div class="about-bottom">
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInRight animated" style="visibility: visible;">A New Generation of TMSL</h3>
